...
const TWITCH_OAUTH_REVOKE_URL = "https://id.twitch.tv/oauth2/revoke";
const TWITCH_HELIX_BASE_URL = "https://api.twitch.tv/helix";

export { TWITCH_OAUTH_TOKEN_URL, TWITCH_OAUTH_AUTHORIZE_URL, TWITCH_OAUTH_REVOKE_URL, TWITCH_HELIX_BASE_URL };
